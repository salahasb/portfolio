...
function Hero({ className }) {
	...
	return (
		...
		>
			...
			<p className="animate-[fadeIn-translateUp_1s_0.5s_forwards] opacity-0 translate-y-[10rem] w-[95%] 425:w-[90%] 500:w-[85%] lg:max-w-[90rem] xl:max-w-[100rem] text-[1.4rem] 425:text-[1.6rem] 500:text-[1.8rem] md:text-[2rem] 900:text-[2rem] lg:text-[2.2rem] xl:text-[2.4rem]   text-center leading-[1.6] mb-8 md:mb-10 lg:mb-14 xl:mb-20 lg:font-medium  ">
