...
function Projects({ className }) {
	...
	return (
		<section
			...
			className={`text-[4rem] absolute  mx-auto max-md:pb-36 top-[4rem] sm:top-[2rem] max-md:mt-[3rem] md:mt-[10rem] left-0   w-full flex flex-col justify-center items-center     ${className}`}
		>
